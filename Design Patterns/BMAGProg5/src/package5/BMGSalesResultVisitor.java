...
{
	/** getSalesResults
	 * Prints sales results for all commission employees under <strong>employee</strong>
	 * @param employee
	 */
	...
	/** getSalesResultsCustom
	 * The same as {@link #getSalesResults(BMGSupervisorEmployee)}, but with a custom iterator.
	 * @param employee
	 */
	public void getSalesResultsCustom(BMGSupervisorEmployee employee)
	{
		//variable declaration
		double nextSalary;
		double nextSales;
