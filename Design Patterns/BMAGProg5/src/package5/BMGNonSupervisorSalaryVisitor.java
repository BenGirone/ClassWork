...
public class BMGNonSupervisorSalaryVisitor
{
	 ...
	 * Prints the weekly salaries of each non-supervisor employee under <strong>employee</strong>, regardless of pay type
	 * @param employee
	 */
	...
	/** getNonSupervisorsSalariesCustom
	 * The same as {@link #getNonSupervisorsSalaries(BMGSupervisorEmployee)}, but with a custom iterator.
	 * @param employee
	 */
	public void getNonSupervisorsSalariesCustom(BMGSupervisorEmployee employee)
	{
		//variable declaration
		double nextSalary;
		BMGIEmployee nextEmployee;
